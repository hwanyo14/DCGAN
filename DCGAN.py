    ...
    def train(self):
        for epoch in range(1, self.max_epoch+1):
            ...
            for idx, (data, _) in enumerate(tqdm(self.dataloader)):
                ...
                real_loss = self.loss_func(real_pred.view(self.batch_size, -1), self.real_label)
                fake_loss = self.loss_func(fake_pred.view(self.batch_size, -1), self.fake_label)
                ...
                g_loss = self.loss_func(fake_pred.view(self.batch_size, -1), self.real_label)
